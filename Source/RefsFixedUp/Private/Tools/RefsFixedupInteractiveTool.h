...
#include "RefsFixedUpInteractiveTool.generated.h"


/**
 * Builder for URefsFixedUpInteractiveTool
 */
UCLASS()
class REFSFIXEDUP_API URefsFixedUpInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the URefsFixedUpInteractiveTool
 */
UCLASS(Transient)
class REFSFIXEDUP_API URefsFixedUpInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	URefsFixedUpInteractiveToolProperties();
...
/**
 * URefsFixedUpInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class REFSFIXEDUP_API URefsFixedUpInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<URefsFixedUpInteractiveToolProperties> Properties;
