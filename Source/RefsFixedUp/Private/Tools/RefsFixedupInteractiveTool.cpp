...
#include "RefsFixedUpInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "URefsFixedUpInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* URefsFixedUpInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	URefsFixedUpInteractiveTool* NewTool = NewObject<URefsFixedUpInteractiveTool>(SceneState.ToolManager);
...
URefsFixedUpInteractiveToolProperties::URefsFixedUpInteractiveToolProperties()
{
...
void URefsFixedUpInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void URefsFixedUpInteractiveTool::Setup()
{
	...
	Properties = NewObject<URefsFixedUpInteractiveToolProperties>(this, "Measurement");
...
void URefsFixedUpInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit URefsFixedUpInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void URefsFixedUpInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void URefsFixedUpInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit URefsFixedUpInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void URefsFixedUpInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void URefsFixedUpInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void URefsFixedUpInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void URefsFixedUpInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
