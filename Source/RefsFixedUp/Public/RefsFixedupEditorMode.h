...
#include "RefsFixedUpEditorMode.generated.h"
 ...
 */
UCLASS()
class URefsFixedUpEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_RefsFixedUpEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	URefsFixedUpEditorMode();
	virtual ~URefsFixedUpEditorMode();
